...
My current focus is turning complex datasets into reliable pipelines and useful applications. I care about clear data models, tested code, thoughtful interfaces, and secure access control.
...
- **[SecondSeven](https://github.com/Hgaines88/SecondSeven)** — A collection of tested Python and Java applications exploring OOP, command-line interfaces, and software fundamentals.
...
**Trainspotting** — A new, security-focused evolution of my fashion archive, with authenticated administration and a moderated, source-driven contribution workflow. The repository is private while active development is underway.
